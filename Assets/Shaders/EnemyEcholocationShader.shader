Shader "Custom/EnemyEcholocation"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Враг подсвечивается красным — сразу видно что опасность
            static const float4 BASE_COLOR  = float4(0, 0, 0, 1);
            static const float4 PING_COLOR  = float4(30.0, 1.0, 0.5, 1);   // красно-оранжевый
            static const float4 TRAIL_COLOR = float4(10.0, 0.3, 0.2, 1);    // тёмно-красный остаток
